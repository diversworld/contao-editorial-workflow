...
$GLOBALS['TL_DCA']['tl_page']['fields']['workflow_status'] = [
...
$GLOBALS['TL_DCA']['tl_page']['fields']['workflow_comment'] = [
...
if (isset($GLOBALS['TL_DCA']['tl_page']['palettes']) && is_array($GLOBALS['TL_DCA']['tl_page']['palettes'])) {
    foreach ($GLOBALS['TL_DCA']['tl_page']['palettes'] as $name => $palette) {
        ...
        if (str_contains($palette, 'publish_legend')) {
            ...
            $GLOBALS['TL_DCA']['tl_page']['palettes'][$name] .= ';{workflow_legend},workflow_status,workflow_comment';
            continue;
        }

...
$GLOBALS['TL_DCA']['tl_calendar_events']['fields']['workflow_comment'] = [
...
if (isset($GLOBALS['TL_DCA']['tl_calendar_events']['palettes']) && is_array($GLOBALS['TL_DCA']['tl_calendar_events']['palettes'])) {
    foreach ($GLOBALS['TL_DCA']['tl_calendar_events']['palettes'] as $name => $palette) {
        ...
        if (str_contains($palette, 'publish_legend')) {
            ...
            $GLOBALS['TL_DCA']['tl_calendar_events']['palettes'][$name] .= ';{workflow_legend},workflow_status,workflow_comment';
            continue;
        }

        $pm->applyToPalette($name, 'tl_calendar_events');
    }
}
